#Config
PS1="[\A \W]\$ "
HISTFILE=/home/void/.config/ksh/ksh_history
HISTSIZE=500
...
alias images='cd ~/media/imgs && swallowbspwm nsxiv -t */'
alias img='cd ~/media/imgs && swallowbspwm nsxiv -t */'
alias imgs='cd ~/media/imgs && swallowbspwm nsxiv -t */'
...
alias mpv='mpvplus'
alias yt-dlp='cd ~/dl && yt-dlp -f "bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best"'
